...
def ddpg_update_critic(
    ...
    :func:`~.blox.losses.mse_continuous_action_value_loss` to the target
    values :math:`y_i` generated by :func:`q_deterministic_bootstrap_estimate`
    with the target networks ``q_target`` and ``policy_target`` for the critic
