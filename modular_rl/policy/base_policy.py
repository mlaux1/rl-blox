...
class QValueBasedPolicy(BasePolicy):
    ...
    def __init__(self,
        ...
        self.value_function = TabularQFunction(observation_space,
                                               action_space,
                                               initial_value)
...
class EpsilonGreedyPolicy(QValueBasedPolicy):
    ...
    def get_action(self,
        ...
        if default_rng(SEED).random() < self.epsilon:
            return self.action_space.sample()
        else:
            return np.random.choice(
                np.flatnonzero(self.value_function.values[observation] == self.value_function.values[observation].max()))
