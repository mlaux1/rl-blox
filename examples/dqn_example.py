...
from rl_blox.algorithms.model_free.dqn import train_dqn
...
# Set up policy and q network
policy = DeterministicMlpPolicyNetwork.create([256, 256], envs)
q = MlpQNetwork(hidden_nodes=[256, 256])

# Train
q, q_params = train_dqn(
    envs, q, gradient_steps=1, seed=seed, total_timesteps=31_000, verbose=1
)
envs.close()
